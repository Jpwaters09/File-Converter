# Privacy Policy for File Converter
## Effective Date: 08/11/2025

File Converter is committed to protecting your privacy. This Privacy Policy outlines how we handle information and permissions required to operate the application.

### 1. Information We Collect:
Our application does not collect, store, or transmit any personal data. The app requires access to user-selected files solely for its functionality, which includes reading and converting files between supported formats.
...
<ul>
	<li>File Processing: The app reads the content of selected files to convert them between supported formats. Once the conversion is complete, the resulting files are saved to the specified location.</li>
...
File Converter does not use third-party services, APIs, or integrations that handle your data. All actions occur locally on your device.
...
### 5. Your Rights:
As a user of File Converter, you retain full control over how the app interacts with your files. Specifically:
<ul>
