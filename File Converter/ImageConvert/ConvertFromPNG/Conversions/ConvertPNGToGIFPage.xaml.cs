...
{
    public sealed partial class ConvertPNGToGIFPage : Page
    {
        ...
        private static string? PNGToGIFFinishedDialogTitle { get; set; } = "";
        private static string? FinishedDialogCloseButtonText { get; set; } = "";
        private static string? FinishedDialogErrorTitle { get; set; } = "";

        public ConvertPNGToGIFPage()
        {
            InitializeComponent();

            var resourceLoader = new ResourceLoader();

            PNGToGIFFinishedDialogTitle = resourceLoader.GetString("PNGToGIFFinishedDialogTitle");
        ...
        {
            PNGToGIFFinishedDialogTitle = string.Format(PNGToGIFFinishedDialogTitle, ImageFileName);

            SystemSounds.Asterisk.Play();

            ContentDialog FinishedDialog = new ContentDialog()
            {
                Title = PNGToGIFFinishedDialogTitle,
