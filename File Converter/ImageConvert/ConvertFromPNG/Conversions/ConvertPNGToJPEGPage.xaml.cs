...
{
    public sealed partial class ConvertPNGToJPEGPage : Page
    {
        ...
        private static string? PNGToJPEGFinishedDialogTitle { get; set; } = "";
        private static string? FinishedDialogCloseButtonText { get; set; } = "";
        private static string? FinishedDialogErrorTitle { get; set; } = "";

        public ConvertPNGToJPEGPage()
        {
            InitializeComponent();

            var resourceLoader = new ResourceLoader();

            PNGToJPEGFinishedDialogTitle = resourceLoader.GetString("PNGToJPEGFinishedDialogTitle");
        ...
        {
            PNGToJPEGFinishedDialogTitle = string.Format(PNGToJPEGFinishedDialogTitle, ImageFileName);

            SystemSounds.Asterisk.Play();

            ContentDialog FinishedDialog = new ContentDialog()
            {
                Title = PNGToJPEGFinishedDialogTitle,
