...
{
    public sealed partial class ConvertPNGToSVGPage : Page
    {
        ...
        private static string? PNGToSVGFinishedDialogTitle { get; set; } = "";
        private static string? FinishedDialogCloseButtonText { get; set; } = "";
        private static string? FinishedDialogErrorTitle { get; set; } = "";

        public ConvertPNGToSVGPage()
        {
            InitializeComponent();

            var resourceLoader = new ResourceLoader();

            PNGToSVGFinishedDialogTitle = resourceLoader.GetString("PNGToSVGFinishedDialogTitle");
        ...
        {
            PNGToSVGFinishedDialogTitle = string.Format(PNGToSVGFinishedDialogTitle, ImageFileName);

            SystemSounds.Asterisk.Play();

            ContentDialog FinishedDialog = new ContentDialog()
            {
                Title = PNGToSVGFinishedDialogTitle,
