...
{
    public sealed partial class ConvertPNGToPSDPage : Page
    {
        ...
        private static string? PNGToPSDFinishedDialogTitle { get; set; } = "";
        private static string? FinishedDialogCloseButtonText { get; set; } = "";
        private static string? FinishedDialogErrorTitle { get; set; } = "";

        public ConvertPNGToPSDPage()
        {
            InitializeComponent();

            var resourceLoader = new ResourceLoader();

            PNGToPSDFinishedDialogTitle = resourceLoader.GetString("PNGToPSDFinishedDialogTitle");
        ...
        {
            PNGToPSDFinishedDialogTitle = string.Format(PNGToPSDFinishedDialogTitle, ImageFileName);

            SystemSounds.Asterisk.Play();

            ContentDialog FinishedDialog = new ContentDialog()
            {
                Title = PNGToPSDFinishedDialogTitle,
