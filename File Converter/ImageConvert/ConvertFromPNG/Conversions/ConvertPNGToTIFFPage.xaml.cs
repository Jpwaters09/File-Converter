...
{
    public sealed partial class ConvertPNGToTIFFPage : Page
    {
        ...
        private static string? PNGToTIFFFinishedDialogTitle { get; set; } = "";
        private static string? FinishedDialogCloseButtonText { get; set; } = "";
        private static string? FinishedDialogErrorTitle { get; set; } = "";

        public ConvertPNGToTIFFPage()
        {
            InitializeComponent();

            var resourceLoader = new ResourceLoader();

            PNGToTIFFFinishedDialogTitle = resourceLoader.GetString("PNGToTIFFFinishedDialogTitle");
        ...
        {
            PNGToTIFFFinishedDialogTitle = string.Format(PNGToTIFFFinishedDialogTitle, ImageFileName);

            SystemSounds.Asterisk.Play();

            ContentDialog FinishedDialog = new ContentDialog()
            {
                Title = PNGToTIFFFinishedDialogTitle,
